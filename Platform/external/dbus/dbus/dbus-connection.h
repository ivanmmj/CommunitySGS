...
dbus_bool_t dbus_connection_get_object_path_data   (DBusConnection              *connection,
                                                    ...
                                                    void                       **data_p);
// start brcm ryu 2010.06.02
dbus_bool_t dbus_connection_register_obex_object_path   (DBusConnection              *connection,
                                                    const char                  *path,
                                                    const DBusObjectPathVTable  *vtable,
                                                    void                        *user_data);
dbus_bool_t dbus_connection_unregister_obex_object_path (DBusConnection              *connection,
                                                    const char                  *path);

dbus_bool_t dbus_connection_get_obex_object_path_data   (DBusConnection              *connection,
                                                    const char                  *path,
                                                    void                       **data_p);
// end brcm ryu
